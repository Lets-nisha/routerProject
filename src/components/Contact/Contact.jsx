                        ...
                        <form className="p-6 flex flex-col justify-center">
                            ...
                            <div className="flex flex-col">
                                ...
                                <input
                                    ...
                                    className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-600 text-gray-800 dark:text-white font-semibold focus:border-orange-500 focus:outline-none"
                                />
                            </div>
